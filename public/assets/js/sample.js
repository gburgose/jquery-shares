...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
	...
	var share__constructor = function share__constructor($anchor) {
		share__createUrl($anchor);
	};

	var share__createUrl = function share__createUrl($anchor) {
	...
	var share__debug = function share__debug(type, text) {
		if (window.console) {
			if (type === "warn") {
				console.warn(text);
			} else if (type === "log") {
	...
	var share__defineType = function share__defineType($anchor) {
	...
	var share__click = function share__click(e) {
		e.preventDefault();
		share__popupWindow($(this).attr('href'), 500, 310);
	};

	var share__popupWindow = function share__popupWindow(url, w, h) {
		var left, top;
